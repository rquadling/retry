...
use RQuadling\Retry\Policy\CallableRetryPolicy;
...
class CallableRetryPolicyTest extends TestCase
{
    ...
    public function testDefaultAlwaysRetry()
    {
    ...
    public function testSimpleShouldRetryCallback()
    {
    ...
    public function testSettingMethodInConstructor()
    {
